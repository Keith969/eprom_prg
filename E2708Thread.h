#ifndef E2708THREAD_H
#define E2708THREAD_H

// *****************************************************************************
// File         [ E2708Thread.h ]
// Description  [ Implementation of the E2708Thread class ]
// Author       [ Keith Sabine ]
// *****************************************************************************
...
// Description  [ ]
// *****************************************************************************
class E2708Thread : public QThread
{
    Q_OBJECT

public:
    explicit                E2708Thread(QObject* parent = nullptr);
                            ~E2708Thread();
